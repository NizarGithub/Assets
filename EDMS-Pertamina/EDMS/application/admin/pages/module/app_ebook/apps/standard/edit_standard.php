 ...
 */
$data = $ARSql->getOne('standard','id_std',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend>Informasi Standard<?php echo btnBack('e-book','standard');?></legend><br>
                    <div class="control-group ">
                        <label class="control-label">Judul Buku <span class="required">*</span></label>
                        <div class="controls">
                            <input type="hidden" name="id_std" value="<?php echo $data->id_std;?>">
                            <input value="<?php echo $data->standard;?>" required name="judul" class="span8" type="text" autocomplete="false">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea required name="desc" class="ckeditor" type="text"><?php echo $data->description;?></textarea>
