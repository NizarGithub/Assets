	...
	<table class="data">
		...
		<tbody>
			...
			foreach($sql as $row){	
				...
				echo "<tr><td align='center'>$check</td><td>$name</td><td><div class='switch-group'>$sname$status</div></td><td>$row[position]</td><td>$row[folder]</td><td align='center'>$row[short]</td><td align='center'>$level</td><td align='center'>$row[id]</td></tr>";
				$no++;	
			}
			?>
        </tbody>			
