 ...
 */
$data = $ARSql->getOne('kursus','id_kurs',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend>Informasi Buku</legend><br>
                    <div class="control-group ">
                        <label class="control-label">Materi <span class="required">*</span></label>
                        <div class="controls">
                            <input type="hidden" name="id_kurs" value="<?php echo $data->id_kurs;?>">
                            <input id="current-pass-control" value="<?php echo $data->materi;?>" required name="judul" class="span8" type="text" value="" autocomplete="false">
