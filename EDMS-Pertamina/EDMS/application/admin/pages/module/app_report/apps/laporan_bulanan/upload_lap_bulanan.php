...
<div class="span16">
    <div class="box">
        ...
        <div class="row">
            ...
            <h2>Tambah Laporan Bulanan Baru :</h2>
            <p>
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informas Laporan Bulanan</span><?php echo btnBack('report', 'lap_bulanan');?></legend><br>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input required name="b" class="span4" type="text">
