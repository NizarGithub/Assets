    ...
    <div class="span16">
        <div class="blockoff-right">
            <?php
                ...
                echo "<h3><i class='icon-file'></i> &nbsp;File HTACCESS</h3>";
                ...
                fclose($fh);
                echo "<form enctype='multipart/form-data' action='admin.php?mod_apps=themes&media_app=htaccess&action=aksi_htaccess' method='post'>";
