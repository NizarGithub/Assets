...
<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?app=profil&act=aksi">
	<div id="app_header">
		<div class="warp_app_header">
			...
			<button type="submit" class="btn btn-success" title="Simpan dan keluar" value="Next" name="update_exit"><i class="icon-ok-sign"></i> Simpan dan keluar</button>	
				<a class="danger btn btn-default" href="?app=profil" title="Batal"><i class="icon-remove-sign"></i> Batal</a>
			</div>
		</div>			 
	</div>
    <script> 
