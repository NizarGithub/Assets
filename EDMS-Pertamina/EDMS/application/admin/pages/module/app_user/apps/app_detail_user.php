...
<div class="span16">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-info btn-small btn-box-right" href="admin.php?mod_apps=user">
			...
			<?php echo html_entity_decode($data->bio); ?>
                    ...
                    <div class="box-footer">
                       <a href='admin.php?mod_apps=user&media_app=app_edit_user&id=<?php echo $data->id_user; ?>' class='btn btn btn-info'>
