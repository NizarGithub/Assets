...
<div class="span16">
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi WPS</span><a href="admin.php?mod_apps=engine-docs&media_app=wps" style="font-weight: normal; margin-top: 5px;" class="pull-right btn-info btn btn-small"><i class="icon-circle-arrow-left"></i>&nbsp; Kembali</a></legend><br>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea  name="d" class="span8"></textarea>
