...
$data = $ARSql->getOne('cormon','id_cormon',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="box-content">
            <form enctype="multipart/form-data" action="admin.php?mod_apps=engine-docs&media_app=cormon&action=aksi_cormon" method="post">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi Cormon</span><a href="admin.php?mod_apps=engine-docs&media_app=cormon" style="font-weight: normal; margin-top: 5px;" class="pull-right btn-info btn btn-small"><i class="icon-circle-arrow-left"></i>&nbsp; Kembali</a></legend><br>
                    <div class="control-group ">
                        <label class="control-label">Unit Cormon <span class="required">*</span></label>
                        <div class="controls">
                            <input type="hidden" name="id_cor" value="<?php echo $data->id_cormon;?>">
                            <input required name="a" value="<?php echo $data->unit_cor;?>" class="span8" type="text">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea id="current-pass-control"  required name="b" class="ckeditor" type="text" ><?php echo $data->equipment;?></textarea>
