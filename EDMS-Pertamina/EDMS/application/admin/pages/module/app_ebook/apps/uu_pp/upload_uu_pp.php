...
<div class="span16">
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi UU dan PP</span><a href="admin.php?mod_apps=e-book&media_app=uu_pp" style="font-weight: normal; margin-top: 5px;" class="pull-right btn-info btn btn-small"><i class="icon-circle-arrow-left"></i>&nbsp; Kembali</a></legend><br>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="current-pass-control" required name="perihal" class="span8" type="text" value="" autocomplete="false">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="current-pass-control" required name="tahun" class="span2" type="text" autocomplete="false">
