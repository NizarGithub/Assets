...
<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?app=admin&act=aksi">
	<div id="app_header">
		<div class="warp_app_header">
			<div class="app_title">Edit Admin</div>
			<div class="app_link">
...
<div class=" box-left">
	<div class="box">								
		...
		<div>
			<table>
				<tr>
                                     <input type="hidden" value="<?php echo $b->id_admin;?>" name="id"> 
                                    <td class="row-title"><span class="tips" title="Nama Admin">Nama Lengkap</td>
                                    <td>
                                        <input type="text" value="<?php echo $b->nama_lengkap;?>" name="nama" style="width: 100%" required></td>
				</tr>
                                <tr>
                                    <td class="row-title"><span class="tips" title="Alamat">Alamat Lengkap</td>
                                    <td>
                                        <textarea name="alamat" style="width: 100%" required ><?php echo $b->alamat;?></textarea></td>
				</tr>
                                <tr>
                                    <td class="row-title"><span class="tips" title="Tempat lahir">Tempat Lahir</td>
                                    <td>
                                        <input type="text" value="<?php echo $b->tempat_lahir;?>" name="tlahir" style="width: 100%" required></td>
				</tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input value="<?php echo $b->no_telp;?>" type="text" name="no_telp" style="width: 100%"></td>
                                    </tr>
                                    <tr>
            ...
            ?>
                ...
                <a href='#' class='btn btn-default fileinput-exists' data-dismiss='fileinput'>Hapus</a> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo $b->username; ?>" name="uname" style="width: 100%" required></td>
				</tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="email" value="<?php echo $b->email;?>" name="email" style="width: 100%" required id="uname"></td>
				</tr>
                                <tr>
                                    <td class="row-title"><span class="tips" title="Website, blog atau link media sosial">Website</td>
                                    <td>
                                        <input type="text" value="<?php echo $b->website;?>" name="website" style="width: 100%" id="uname"></td>
				</tr>
				<tr>
