 ...
 */
$data = $ARSql->getOne('pelat_pekerja','id_pp',$_GET['id']);
?>
            ...
            <div class="span7">
                <fieldset>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                             <input type="hidden" name="id_pelat" value="<?php echo $data->id_pp;?>">
                            <textarea required name="a" class="ckeditor" type="text"><?php echo $data->keterangan;?></textarea>
