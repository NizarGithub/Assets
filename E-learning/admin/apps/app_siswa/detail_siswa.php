...
?>
	<div id="app_header">
		<div class="warp_app_header">
			...
			<div class="app_link">
			<button onclick="window.location='?app=siswa&act=edit&id=<?php echo $id;?>';" class="btn btn-success" title="Simpan dan keluar" value="Next"><i class="icon-pencil"></i>  Edit data</button>	
				<a class="danger btn btn-default" href="?app=siswa" title="Batal"><i class="icon-remove-sign"></i> Kembali</a>
			</div>
		</div>			 
	</div>
<div class=" box-left">
