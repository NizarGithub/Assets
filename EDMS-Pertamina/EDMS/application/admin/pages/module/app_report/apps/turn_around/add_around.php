            ...
            <div class="span7">
                <fieldset>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input required name="b" class="span3" type="date">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input required name="c" required  class="span8" type="text" value="" autocomplete="false">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input required name="d" required  class="span8" type="text" value="" autocomplete="false">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea  name="e" class="span8" type="text"></textarea>

                        </div>
                    </div>
                    <div class="control-group ">
                        <label class="control-label">Tindak Lanjut <span class="required">*</span></label>
                        <div class="controls">
                            <input required name="f" required  class="span8" type="text" value="" autocomplete="false">
