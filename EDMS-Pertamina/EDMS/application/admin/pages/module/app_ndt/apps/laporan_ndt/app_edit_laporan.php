 ...
 */
$data = $ARSql->getOne('laporan_ndt','id_ndt',$_GET['id']);
?>
            ...
            <div class="span7">
                <fieldset>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input type="hidden" name="id_ndt" value="<?php echo $data->id_ndt;?>">
                           <input required  value="<?php echo $data->tag_no;?>" name="e" class="span8 form-control" type="text">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input type="text" required name="b" value="<?php echo $data->requestor; ?>" class=" form-control span8" autocomplete="false">
                        ...
                        <div class="controls">
                            <select name="c" id="challenge_question_control" class="span5 form-control">
                                ...
                                while ($dLevel = $ARSql->mf_object($qLevel)) {
                                    echo "<option value='".$dLevel->id_jenis."'";
                                    echo $data->id_jenis==$data->id_jenis ? 'selected' : '';
                    ...
                    <div class="control-group ">
                        <label class="control-label">Permintaan <span class="required">*</span></label>
                        <div class="controls">
                            <textarea class="ckeditor" required name="d" class="span8"><?php echo $data->permintaan;?></textarea>
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                             <input required id="datepicker" value="<?php echo $data->tgl;?>" name="tgl" class="span8 form-control" type="text">
