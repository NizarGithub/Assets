...
$data   = $ARSql->getOne('foto_ta','id_fta',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="box-content">
            <form enctype="multipart/form-data" action="admin.php?mod_apps=foto&media_app=foto_ta&action=aksi_foto_ta" method="post">
        ...
        <div class="alert alert-block alert-warning">
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi Foto TA</span><?php echo btnBack('foto', 'foto_ta');?></legend><br>
                    <div class="control-group ">
                        <label class="control-label">Keterangan<span class="required">*</span></label>
                        <div class="controls">
                            <input type="hidden" name="id_fta" value="<?php echo $data->id_fta; ?>">
                   ...
                   <div class="control-group ">
                    ...
                    <div class="control-group ">
                     <label class="control-label">Foto TA <span class="required">*</span></label>
                   <div class="controls">
                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                  <div class="fileupload-preview thumbnail"><img src="uploaded/foto_TA/<?php echo medium_.$data->foto ?>" width="i50" height="150" /></div>
                                <div><br>
