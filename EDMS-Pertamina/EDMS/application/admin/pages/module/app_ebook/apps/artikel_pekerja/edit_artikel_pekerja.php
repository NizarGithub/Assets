...
$data = $ARSql->getOne('artikel_pekerja','id_art',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="box-content">
            <form enctype="multipart/form-data" action="admin.php?mod_apps=e-book&media_app=artikel_pekerja&action=aksi_artikel_pekerja" method="post">
    
        
        <div class="row">
            <div class="span7">
                <div class="alert alert-block alert-info">
            <h2>Edit Artikel Pekerja :</h2>
            <p>
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi Artikel Pekerja</span><?php echo btnBack('e-book','artikel_pekerja');?></legend><br>
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            ...
                            <input required name="a" value="<?php echo $data->judul;?>" class="span8" type="text">
                    ...
                    <div class="control-group ">
                        <label class="control-label">Pengarang <span class="required">*</span></label>
                        <div class="controls">
                            <input required name="c" value="<?php echo $data->pengarang;?>" class="span8" type="text">
