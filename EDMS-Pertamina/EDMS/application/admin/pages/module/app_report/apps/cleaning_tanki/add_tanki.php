...
<div class="span16">
    <div>
        <form action="Import.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group ">
                        <div class="controls">
                            <button type="submit" class="btn btn-primary" name="submit_import_cleaning_tanki"><i class="icon-ok"></i> Import Data</button>
                        </div>
                    </div>
        </form>
    </div><br>
    <div class="box">
        ...
        <div class="row">
            ...
            <h2>Added New Cleaning Tangki :</h2>
            <p>
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi Cleaning Tangki</span></legend><br>
                    <div class="control-group ">
