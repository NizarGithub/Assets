...
<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?app=admin&act=aksi">
	<div id="app_header">
		<div class="warp_app_header">
			<div class="app_title">Tambah Admin</div>
			<div class="app_link">
				...
				<a class="danger btn btn-default" href="?app=admin" title="Batal"><i class="icon-remove-sign"></i> Batal</a>
			</div>
		</div>			 
	</div>
    <script> 
        ...
        var username  = uname; 
            if(username=='') {
                $("#pesan").html("<span style='color: red'><i class='icon-remove-sign'></i> Jangan kosong...</span>");	
                    ...
                    $.ajax({
                     type:"POST",
                     url:"apps/app_admin/controller/cekable.php",    
		...
		<div>
			<table>
				<tr>
                                ...
                                <tr>
                                    <td class="row-title"><span class="tips" title="Nama Admin">Alamat Lengkap</td>
                                    <td>
        ...
        <div class='fileinput fileinput-new' data-provides='fileinput'>
            ...
            <img src='assets/Images/contoh.png' alt='...'>
                ...
                <a href='#' class='btn btn-default fileinput-exists' data-dismiss='fileinput'>Hapus</a> 
                                ...
                                <tr>
                                    <td class="row-title"><span class="tips" title="Password">Ulangi Password</td>
                                    <td>
				...
				<tr>
					...
					<td style="padding: 5px 10px;">
						<p class="switch">
                                                    <input id="radio1" value="Y" name="blokir" type="radio" checked class="invisible">
                                                    <input id="radio2" value="N" name="blokir" type="radio" class="invisible">
