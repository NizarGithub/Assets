...
?>
        ...
        <form action="Import.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group ">
                        <div class="controls">
                            <button type="submit" class="btn btn-primary" name="submit_import_termo"><i class="icon-ok"></i> Import Data</button>
                        </div>
                    </div>
        </form>
    </div><br>
            ...
            <div id="acct-password-row" class="span7">
             ...
             <div id="acct-password-row" class="span7">
                   <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="new-pass-control" required name="d" class="span4" type="date" value="" autocomplete="false">
