...
$data = $ARSql->getOne('laporan_bulanan','id_lap',$_GET['id']);
?>
...
<div class="span16">
    <div class="box">
        ...
        <div class="box-content">
            <form enctype="multipart/form-data" action="admin.php?mod_apps=report&media_app=lap_bulanan&action=aksi_lap_bulanan" method="post">
        ...
        <div class="row">
            ...
            <div class="span7">
                <fieldset>
                    <legend><span class="badge badge-info"> Informasi Laporan Bulanan</span><?php echo btnBack('report', 'lap_bulanan');?></legend><br>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input required name="b" value="<?php echo $data->bulan;?>" class="span4" type="text">
