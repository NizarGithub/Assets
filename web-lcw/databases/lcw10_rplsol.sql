...
--
-- Inang: localhost
-- Waktu pembuatan: 28 Jan 2015 pada 10.20
...
--
-- Basis data: `lcw10_rplsol`
--
CREATE DATABASE IF NOT EXISTS `lcw10_rplsol` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `lcw10_rplsol`;
...
(1, 'Robotic Programmer', 'ibeesnay@yahoo.com', '0852-9015-6462', 'Sebagai alat untuk merekam sebuah mimpi', 'Alat Perekam Mimpi', 'http://localhost/web/lcw-upi', 'MemberQuarter-large.gif', 'N', 10, 3);
...
--
-- Dumping data untuk tabel `log_team`
--
...
--
-- Struktur dari tabel `member_forum`
--
...
--
-- Dumping data untuk tabel `member_forum`
--
...
--
-- Struktur dari tabel `sensor_kata`
--
...
--
-- Dumping data untuk tabel `sensor_kata`
--
...
--
-- Struktur dari tabel `tanggapan_forum`
--
...
(1, 'Administrator', '', 'admin', '6715511e7ece50f05f68c110eef6708c', 1, 'naytea.jpg', 'ibeesnay@yahoo.com', 'L', '1996-09-13', 'Tarikolot', '082218869439', 'admin', '2015-01-28 10:14:09', 'Y', 0),
...
--
-- Struktur dari tabel `topik_forum`
--
...
--
-- Dumping data untuk tabel `topik_forum`
--
