...
<div class="x_content">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="today-r"><br>
                                                <?php require_once 'module/log_aktifitas/today.php'; ?>
                                            </div>
                                            <div class="tab-pane" id="yesterday-r"><br>
        ...
        <div class="x_panel tile fixed_height_300">
            ...
            <div class="x_content">
                                <div class="dashboard-widget-content">
                                    <ul class="quick-list">
                                        <?php
                                        $row = $query->detail_user($_SESSION[id_user]);
                                        ?>
                                        ...
                                        <li><a data-toggle="tooltip" data-placement="top" title="Tipe Kunci">
                                            <i class="fa fa-key" title="Tipe Kunci"></i>
                                                <?php 
                                        if($row[locktype]=='1'){
                                        echo Pola; 
                                        }else{
